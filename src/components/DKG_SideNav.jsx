...
const SideNav = ({ collapsed, toggleCollapse }) => {
  ...
  const blockableDuties = {
    '/sms/dutyStart': { dutyKey: 'smsDuty', title: 'SMS' },
    '/stage/startDuty': { dutyKey: 'rollingDuty', title: 'Rolling Stage' },
    '/ndt/startDuty': { dutyKey: 'ndtDuty', title: 'NDT' },
    '/testing/startDuty': { dutyKey: 'testingDuty', title: 'Testing' },
    '/visual/startDuty': { dutyKey: 'viDuty', title: 'Visual Inspection' },
    '/welding/startDuty': { dutyKey: 'weldingDuty', title: 'Welding Inspection' },
    '/srInspection': { dutyKey: 'sriDuty', title: 'Short Rail Inspection' }
  };
