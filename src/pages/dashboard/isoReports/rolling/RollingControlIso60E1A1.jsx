  ...
  const onFinish = async (formData) => {
    ...
    try {
      const { data } = await apiCall(
        ...
        token,
        { ...formData, railSection: "60E1A1", mill: "RSM" }
      );
  ...
  return (
    <div>
      ...
      <div className="a4-container" ref={repRef}>
        <IsoHeader
          engTitle="FORMAT FOR ROLLING STAGE CONTROL 60E1A1 (RSM) <br /> (Clause No. 8.5 of ISO 9001:2015)"
          hinTitle="रोलिंग चरण नियंत्रण के लिए प्रारूप (60ई1ए1) (आरएसएम)"
