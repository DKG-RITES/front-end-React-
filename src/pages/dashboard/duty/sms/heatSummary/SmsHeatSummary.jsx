...
//       // Filter out heats where bloom cutting details have been entered
//       const filteredHeatDtlList = (responseData?.heatDtlList || []).filter(
//         (heat) => !heat.bloomCuttingEntered // or use your actual property name
//       );
...
//         heatDtlList: filteredHeatDtlList,
//       });
//     } catch (error) {}
