...
const FinishingVerification = () => {
  ...
  const deleteHotStamping = (index) => {
    setFormData((prev) => ({
      ...prev,
      hotStampingList: prev.hotStampingList.filter((_, i) => i !== index),
    }));
  };
  ...
  const addPreCambering = () => {
    setFormData((prev) => ({
      ...
      preCamberingList: [
        ...
        { heatNo: null, isSatisfactory: null, isSatisfactoryDesc: null },
      ],
    }));
  };
  ...
  const deletePreCambering = (index) => {
    setFormData((prev) => ({
      ...prev,
      preCamberingList: prev.preCamberingList.filter((_, i) => i !== index),
    }));
  };
