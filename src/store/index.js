...
import aiDashboardSlice from './slice/aiDashboardSlice.jsx';

const persistConfig = {
	key: 'root',
	version: 1,
	storage,
	whitelist: ['auth', 'smsDuty', 'rollingDuty', 'calibrationDuty', 'ndtDuty', 'viDuty', 'weldingDuty', 'qctDuty', 'sriDuty', 'testingDuty', 'aiDashboard'],
};
